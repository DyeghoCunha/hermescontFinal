  ...
  return (
    ...
    >
      <Stack
        ...
        pt={{ base: "100px", md: "0" }}
      >
        <Box w={{ base: "100%", md: "50%", xxl: "45%" }} position="relative">
          <MotionImage
            src={imageSrc}
            alt="Foto da equipe Hermes"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <Heading
            ...
            w="100vw"
            pl="2%"
            fontSize={{ base: "14vw", md: "7vw",xxl:"5.7vw" }}
            color="white"
          >
            <GradientText style={""}>Quem Somos</GradientText>
          </Heading>
        </Box>
        <VStack w={{ base: "100%", md: "50%", xxl: "55%" }}>
          <Box onMouseLeave={handleMouseLeave}>
            {cardProps.map((props, index) => (
              <Box
                key={index}
                my={10}
                onMouseOver={() => handleMouseEnter(props.image)}
              >
