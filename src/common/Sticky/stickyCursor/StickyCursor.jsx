  ...
  return (
    <div >
      <MotionDiv
        ...
        w="55px"
        h="55px"
        bgColor={isCursor?"rgba(45, 226, 250, 0.13)":"rgba(45, 226, 250, 1)"}
        boxShadow={!isCursor?"inset 5px 5px 20px rgba(255,255,255,0.3), inset -5px -5px 20px rgba(0,0,0,0.3)":"none"}
