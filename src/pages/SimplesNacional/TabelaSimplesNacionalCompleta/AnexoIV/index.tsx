            ...
            <Flex w="100%" justify="center" align="center" direction="column">
              <Box as="section">
                ...
                <Text px={5} fontSize="23px" lineHeight="35px">
                  O Anexo IV da tabela do{" "}
                  <Link href="/SimplesNacional/TabelaSimplesNacionalCompleta/">
                    <GradientText style={{ fontWeight: "bold" }}>
                      Simples Nacional{" "}
                    </GradientText>
                  </Link>
                  é destinado às empresas de Serviços: empresas que fornecem
                  serviço de limpeza, vigilância, obras, construção de imóveis,
                  serviços advocatícios. Percentual destinado a cada Tributo de
                  acordo com a sua respectiva Faixa.
                </Text>
              </Box>
              <Box as="section">
                <Heading
                ...
                <Text px={5} fontSize="23px" lineHeight="35px">
                  Desde 2018, as atividades de prestação de serviços seguintes
                  são tributadas pelo Anexo IV, onde não está incluída no
                  Simples Nacional a CPP (Contribuição Previdenciária Patronal),
                  devendo ela ser recolhida segundo a legislação prevista para
                  os demais contribuintes ou responsáveis (LC nº 123/06, art.
                  18, § 5º-C; Resolução CGSN nº 94/2011, art. 25-A, § 1º, IV).
                </Text>

                <Text px={5} fontSize="23px" lineHeight="35px">
                  Na CPP devida pelas empresas do Simples Nacional não se inclui
                  os valores relacionados a terceiros (SENAI, SESC, SEST, SENAT
                  etc.), pois as empresas do Simples Nacional estão dispensadas
                ...
                <Flex justify="center" align="center">
                  ...
                  >
                    ...
                    <ListItem>
                      Serviços advocatícios. (Incluído pela LC nº 147/2014;
                      efeitos: 1º/01/2015)
                    </ListItem>
                  </UnorderedList>
                </Flex>
                  ...
                  <Table>
                    ...
                    >
                      ...
                      <Tr _hover={{ outline: "2px solid black" }}>
                        <Td>5ª Faixa </Td>
                        <Td>
                          40,00%<GradientText style={""}>(*)</GradientText>
                        </Td>
                        <Td>19,20%</Td>
                        <Td>18,80%</Td>
                        <Td>18,08%</Td>
              ...
              <Text px={5} my={5} fontSize="23px" lineHeight="35px">
                <GradientText style={""}>(*)</GradientText> O percentual efetivo
                máximo devido ao ISS será de 5%, transferindo-se a diferença, de
                forma proporcional, aos tributos federais da mesma faixa de
                receita bruta anual. Sendo assim, na 5a faixa, quando a alíquota
              ...
              >
                <Text>
                  <strong>Faixa = </strong>5ª Faixa, com alíquota efetiva
                  superior a 12,5%
                </Text>
                <Text>
                  <strong>CPP = </strong>(Alíquota efetiva 5%) x 65,26%
                </Text>
                <Text>
                  <strong>ISS = </strong>Percentual de ISS fixo em 5%
                </Text>
                <Text>
                  <strong>CSLL = </strong>(Alíquota efetiva 5%) x 32,00%
                </Text>
                <Text>
                  <strong>IRPJ = </strong>(Alíquota efetiva 5%) x 31,33%
                </Text>
                <Text>
                  <strong>Cofins = </strong>(Alíquota efetiva 5%) x 30,13%
                </Text>
                <Text>
                  <strong>Pis/Pasep = </strong>(Alíquota efetiva 5%) x 6,54%
                </Text>
              </Card>
            </Flex>
          </VStack>
