          ...
          <VStack>
            <Flex w="100%" justify="center" align="center" direction="column">
              ...
              <Box as="section">
                ...
                <Text px={5} fontSize="23px" lineHeight="35px">
                  Se você utilizar a fórmula, fica fácil descobrir se a
                  tributação da sua empresa se enquadra no Anexo III. Para isso,
                  o resultado do cálculo simples nacional deve ser igual ou
                  superior a 28%. Veja o exemplo:
                </Text>
                <Stack justify="center" direction={{base:"column",md:"row"}} align="center" my="40px">
                  ...
                  <Flex justify="center" align="center">
                    ...
                    >
                      ...
                      <Text px={2}>
                        <strong>Fator R</strong> = R$ 11.200,00 / R$ 40.000,00
                      </Text>
                      <CardFooter
                        p={0}
                        m={0}
                  ...
                  <Table>
                    ...
                    >
                      ...
                      <Tr _hover={{ outline: "2px solid black" }}>
                        ...
                        <Td>43,40%</Td>
                        <Td>
                          33,50%<GradientText style={""}>(*)</GradientText>
                        </Td>
                        <Td>3,50%</Td>
                        <Td>4,00%</Td>
                        <Td>12,82%</Td>
              ...
              >
                ...
                <Text>
                  <strong>CSLL = </strong>(Alíquota efetiva 5%) x 5,26%
                </Text>
                <Text>
                  <strong>IRPJ = </strong>(Alíquota efetiva 5%) x 6,02%
                </Text>
                <Text>
                  <strong>Cofins = </strong>(Alíquota efetiva 5%) x 19,28%
                </Text>
                <Text>
                  <strong>Pis/Pasep = </strong>(Alíquota efetiva 5%) x 4,18%
                </Text>
              </Card>
            </Flex>
          </VStack>
